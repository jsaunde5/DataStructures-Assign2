...
entry in a Double Ended, Doubly Linked List that inserts each entry in order (no need for sorting).

NOTE: Basic outline structure for the DRIVER class has been outlined by Eastern Michigan University Professor, William
Sverdlik. All other code has been written by Jordan Saunders with references from Data Structures & Algorithms in Java text
by Robert Lafore. 
*/
